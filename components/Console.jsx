...
const Console = ({children}) => {
  ...
  return (
    ...
    <motion.div
        ...
        className="bg-[#D0CCBD] w-[450px] h-[700px] rounded-0 rounded-br-[50px] flex flex-col justify-between relative shadow-2xl ml-[2em]">

        {/* box leftside */}
        <div className="bg-[#807e77] w-[60px] h-full absolute skew-y-[45deg] left-[-60px] top-[-30px] z-[100]"/>
        {/* box top */}
        <div className="bg-[#949289] w-[450px] h-[60px] absolute top-[-60px] left-[-31px] skew-x-[45deg]"/>
        {/* shadow behind */}
        <div className="bg-black/80 w-[400px] h-[400px] absolute bottom-[16px] left-[-215px] skew-x-[45deg] z-[-10]"/>
        ...
        {/* on off button */}
        <div onClick={()=> consoleCtx[1](!consoleCtx[0])} className="absolute top-[-25px] left-0 skew-x-[45deg] bg-[#868680] w-24 h-4 hover:cursor-pointer z-[9999]">
        ...
        {/* shadow */}
        <div className="bg-[#B5B3A6] w-[95%] h-[98%] rounded-0 rounded-br-[50px] absolute left-3 top-1 shadow-inner"/>
        ...
        <div className="w-full h-full relative flex flex-col">
            ...
            <div className="w-full h-[150px] flex items-center justify-between my-6">
                ...
                <div className="p-2 rounded-full rotate-[70deg] translate-x-[-90%] bg-[#A09A91]">
                    <div className="hover:cursor-pointer w-14 h-14 bg-[#963750] rounded-full mb-8 relative">
                        <span className="pr-2 absolute right-[-28px] rotate-[-90deg] text-blue-800 uppercase font-bold">A</span>
                    </div>

                    <div className="hover:cursor-pointer w-14 h-14 bg-[#963750] rounded-full relative">
        ...
        <div className="absolute bottom-6 left-[50%] translate-x-[-50%] h-5 w-[60px] rounded-full shadow-lg bg-[#D0CCBD]"/>
